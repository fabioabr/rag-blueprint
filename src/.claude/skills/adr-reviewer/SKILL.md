...
- **ADRs**: `kb/rag-blueprint-adrs-kb/1 - draft/`
- **ADR-001 (referência incontestável)**: `kb/rag-blueprint-adrs-kb/1 - draft/ADR-001_pipeline_geracao_conhecimento_4_fases.txt`
