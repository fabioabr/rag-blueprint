...
aliases:
  ...
  - "Glossário Técnico RAG"
  - "Termos de Infraestrutura"
  - "Dicionário Técnico Pipeline"
superseded_by: null
source_format: txt
source_repo: Rag
source_path: "src/kb/rag-blueprint-adrs-draft/beta/ADR-A05_glossario_termos_infraestrutura.beta.md"
source_beta_ids:
  - "BETA-A05"
...
# ADR-A05 — Glossário de Termos de Infraestrutura e Pipeline
...
- [[ADR-002]] — Soberania de Dados: Trilha Cloud vs. On-Premise (fonte primária do glossário de infraestrutura)
- [[ADR-001]] — Pipeline de Geração de Conhecimento em 4 Fases (termos de pipeline e fases)
- [[ADR-004]] — Segurança e Classificação de Dados (termos de segurança e confidencialidade)
- [[ADR-005]] — Front Matter como Contrato de Metadados (termos de front matter e validação)
- [[ADR-010]] — Git Flow da Base de Conhecimento (termos de versionamento e branching)
- [[ADR-011]] — Segregação de KBs por Confidencialidade (termos de segregação e KBs)
