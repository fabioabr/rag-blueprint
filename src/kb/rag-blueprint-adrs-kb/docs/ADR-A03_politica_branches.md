...
aliases:
  - "ADR-A03"
  - "Politica Branches"
  - "Política de Branching RAG"
  - "Release-Based Flow Branches"
  - "Regras de Branches"
superseded_by: null
source_format: txt
source_repo: Rag
source_path: "src/kb/rag-blueprint-adrs-draft/beta/ADR-A03_politica_branches.beta.md"
source_beta_ids:
  - "BETA-A03"
...
- [[ADR-010]] — Git Flow da Base de Conhecimento (fonte primária: define Release-Based Flow, retenção e proteção)
- [[ADR-001]] — Pipeline de Geração de Conhecimento em 4 Fases (define separação em 2 repositórios)
- [[ADR-008]] — Governança: Papéis, Ciclo de Vida e Rollback (define papel do Curador)
